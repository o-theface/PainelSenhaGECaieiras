...
$(document).ready(function () {
    ...
    const heightPadrao = 1080; // -- Tamanho vertical da tela --
    const widthPadrao = 1920; // -- Tamanho horizontal da tela --
    ...
    $(document).on('keypress', function (e) {
        ...
        if ($("#DigitaSenha").val() !== "---") {
            ...
            if (e.keyCode == 13 && valor != "") {
                ...
                if ($("#SenhaAtual").text() != $("#SenhaAnterior1").text() &&
                    $("#SenhaAtual").text() != $("#SenhaAnterior2").text() &&
                    $("#SenhaAtual").text() != $("#SenhaAnterior3").text() &&
                    $("#SenhaAtual").text() != $("#SenhaAnterior4").text() &&
